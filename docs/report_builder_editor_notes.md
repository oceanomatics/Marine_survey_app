...
| Preview renders annexures | Preview tab renders full report including annexure title pages, document manifests, and clickable cross-reference links. |
