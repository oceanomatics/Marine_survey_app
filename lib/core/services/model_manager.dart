...
//
// Multi-model catalog for sherpa-onnx ASR.  Each model lives in its own
// subdirectory under getApplicationDocumentsDirectory()/sherpa_asr_model/.
...
class SherpaModelConfig {
  ...
  final String quality;       // e.g. 'Fast', 'Accurate'
  final String description;
  final int    estimatedMb;
  final String hfRepo;        // csukuangfj/<repo>
  final Map<String, String> files; // role → filename
...
class ModelManager {
  ...
  /// Actual bytes on disk for a given model (0 if not downloaded).
  ...
  /// Download if needed, return paths.  Used by screens on init.
