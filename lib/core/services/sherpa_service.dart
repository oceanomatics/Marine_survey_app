...
//
// Wraps the sherpa-onnx OnlineRecognizer to provide streaming ASR.
// Feed it audio via startStreaming() and it emits SherpaResult events
// as words are recognised in real time.
