...
class _ChecklistScreenState extends ConsumerState<ChecklistScreen>
  ...
  Widget build(BuildContext context) {
    ...
    // §4.4 auto-tick now runs from ChecklistNotifier's own build() (see
    // checklist_provider.dart), reacting to caseCompletenessProvider
    // directly instead of this screen re-deriving completeness on every
    // rebuild — see the 2026-07-13 review for why.
