// lib/features/capture/screens/quick_capture_screen.dart — stub, will be built out in subsequent sessions
import 'package:flutter/material.dart';
import '../../../shared/theme/app_theme.dart';

class QuickCaptureScreen extends StatelessWidget {
  const QuickCaptureScreen({super.key, required this.caseId, this.reportSection, this.stage});
  final String caseId;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('QuickCaptureScreen')),
